...
public class PopularAdatper extends RecyclerView.Adapter<PopularAdatper.ViewHolder> {

    private Context context;
    private List<PopularModel> popularModelList;

    public PopularAdatper(Context context, List<PopularModel> popularModelList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            rating = itemView.findViewById(R.id.pop_rating_txt);
            discount = itemView.findViewById(R.id.pop_discount_txt);
